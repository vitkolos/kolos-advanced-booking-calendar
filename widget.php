...
// Register widget
add_action( 'widgets_init', 'advanced_booking_calendar_widgets_init' );
function advanced_booking_calendar_widgets_init() {
	register_widget( 'abcAvailabilityFormWidget' );
}
?>
