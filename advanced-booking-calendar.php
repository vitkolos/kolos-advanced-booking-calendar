...
function advanced_booking_calendar_install() {
	...
	add_option ('abc_subject_unconfirmed', '');
	add_option ('abc_text_unconfirmed', '');
	add_option ('abc_subject_confirmed', '');
	add_option ('abc_text_confirmed', '');
	add_option ('abc_subject_canceled', '');
	add_option ('abc_text_canceled', '');
	add_option ('abc_subject_rejected', '');
	add_option ('abc_text_rejected', '');
