...
function advanced_booking_calendar_install() {
	...
	$abc_greeting = __("Hi [abc_first_name]!", 'advanced-booking-calendar')."\n";
	...
	$abc_text_details .= __("Discount", 'advanced-booking-calendar').": [abc_discount]\n";
	$abc_text_details .= __("Total price", 'advanced-booking-calendar').": [abc_total_price]\n";
	$abc_text_details .= __("Checkin - Checkout", 'advanced-booking-calendar').": [abc_checkin_date] - [abc_checkout_date]\n";
	...
	$abc_text_details .= __("Address", 'advanced-booking-calendar').": [abc_address], [abc_zip] [abc_city], [abc_county], [abc_country] \n";
	...
	$abc_text_unconfirmed .=  sprintf(__("Thank you for booking at %s. Your booking has not yet been confirmed. Please wait for an additional confirmation email.", 'advanced-booking-calendar'), get_option( 'blogname' ))."\n\n";
